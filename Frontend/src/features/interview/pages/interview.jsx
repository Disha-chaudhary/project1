...
const AnimatedScore = ({ score }) => {
  ...
  const color =
    score >= 75 ? "#00f5a0" : score >= 50 ? "#f5c400" : "#f55a00";
...
export default function InterviewDashboard({ report }) {
  ...
  const gapList = Array.isArray(skillGaps)
    ? skillGaps
        ...
        <main className={`idb-main ${animateIn ? "fade-in" : "fade-out"}`}>
          {activeTab === "technical" && (
            <div className="questions-panel">
              ...
              <p className="panel-subtitle">{technicalQuestions.length} questions · Click any card to reveal answer</p>
          ...
          {activeTab === "behavioral" && (
            <div className="questions-panel">
              ...
              <p className="panel-subtitle">{behavioralQuestions.length} questions · Click any card to reveal answer</p>
              <div className="accordion-list">
