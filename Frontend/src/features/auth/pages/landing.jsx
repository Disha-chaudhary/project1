    ...
    <footer className="footer">
      <div className="footer__inner">
        ...
        <div className="footer__social">
          <a href="https://github.com/Disha-chaudhary" aria-label="GitHub" className="footer__icon">
          ...
          <a href="https://www.linkedin.com/in/disha-chaudhary-50b148326/" aria-label="LinkedIn" className="footer__icon">
            <svg viewBox="0 0 24 24" fill="currentColor" width="18" height="18">
